            ...
            {issues.length === 0 ? (
              ...
              issues.map((issue) => (
                <Fragment key={issue.issue_id}>
                  ...
                  {issue.children?.map((child) => renderIssueRow(child, true))}
                </Fragment>
              ))
            )}
          </tbody>
            ...
            <div className="project-modal issue-modal">
              ...
              <form onSubmit={handleCreateIssue}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleIssueDataChange("title", e.target.value)
                  }
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleIssueDataChange("description", e.target.value)
                  }
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleIssueDataChange("priority", e.target.value)
                  }
                >
                  <option value="low">Low</option>
                  <option value="medium">Medium</option>
                ...
                {issueData.type !== "story" && (
                  <>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleIssueDataChange("parent_id", e.target.value)
                      }
                    >
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleIssueDataChange("assignee", e.target.value)
                  }
                >
